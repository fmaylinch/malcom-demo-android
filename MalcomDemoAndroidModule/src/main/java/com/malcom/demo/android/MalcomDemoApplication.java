...
public class MalcomDemoApplication extends Application {
    ...
    public void onCreate() {
		...
		MalcomLib.init(this, uuid, secretKey);

		// TODO: Trick to change the malcom api URL
...
//		prefs.edit().putString(MCMCoreAdapter.PROPERTIES_MALCOM_BASEURL, "http://192.168.2.109:8081/malcom-api/").commit();
